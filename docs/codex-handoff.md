...
- Scooter Stripe Checkout allows promotion codes and lazily creates `NEMOB30`: 10% off one scooter order, max 5 redemptions. The code is created in `netlify/functions/create-checkout.js` before the session is opened.
