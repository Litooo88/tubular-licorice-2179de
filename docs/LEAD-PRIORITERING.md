...
1. **Flest gånger ringt.** Missade samtal *från* kundens nummer i 46elks-loggen = aktiv
   kontaktvilja. Max 40 p (4 p per samtal, tak vid 10).
2. **Senast i tiden.** Ärendets ålder: 20 p vid 0 dagar, 0 p vid 40+ dagar.
3. **Chatten granskad — bokning eller generell?** Intentklassning av kundens text:
   konkret fel (punktering, startar inte, felkod…), tidsord (idag, boka, hämta…) eller
   modellnamn ⇒ *bokning* (25 p); "vad kostar / rådgivning / köpa" utan fel ⇒ *generell*
   (0 p); tomt/oklart ⇒ 10 p.
4. **Om bokning: mest pengar på snabbast tid.** Kr per minut ur prislistan per ämne
   ...
   service ~545/45). Max 15 p. Generella frågor får 0.
